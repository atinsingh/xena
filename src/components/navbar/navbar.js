...
export default function NavBar() {
  return (
    <Popover className="navbar-container">
      <div className="absolute inset-0 shadow z-30 pointer-events-none" aria-hidden="true" />
      <div className="relative z-20">
        <div className="navbar-layout">
          <div>
            <a href="#" className="flex">
              <span className="sr-only">PRAGRA</span>
              <img className="logo" src={Logo} alt="PRAGRA" />
            </a>
          </div>
          <div className="-mr-2 -my-2 md:hidden">
            <Popover.Button className="menu_icon">
              ...
              <Popover>
                {({ open }) => (
                  <>
                    ...
                    <NavPopOver menu={solutions} callsToAction={callsToAction}></NavPopOver>
